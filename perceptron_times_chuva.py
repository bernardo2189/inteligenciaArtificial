...
class Perceptron:
	...
	def teste(self, amostra):
		...
		if saida_gerada == 1:
			print('Resultado: %d. Chovera' % saida_gerada)
		else:
			print('Resultado: %d. não chovera' % saida_gerada)
...
while (True):
	...
	x = float(input('Valor para umidade do ar: '))
	y = float(input('Valor para pressão Atmosférica: '))
	print('umidade do ar e pressão Atmosférica:: ', x , ' , ', y)
	rede.teste([x,y])
